...
## APA Journal Article Reporting Standards (JARS) for Bayes
...
## Makowski et al's (briefer) recommendations

<https://easystats.github.io/bayestestR/articles/guidelines.html#how-to-describe-and-report-the-parameters-of-a-model>

Based on thesesuggestions, a template sentence for minimal reporting of a parameter based on
its posterior distribution could be:
