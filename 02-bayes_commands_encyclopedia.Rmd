...
-   `iter` is the number of steps taken in each chain. Kurz/McElreath in chapter 4 note: "you usually only need to set `iter= 2000, warmup=1000` when using moderately better priors [than these terrible uniform ones]"
